...
- **Zero-infra.** Loopdog's thin, deterministic controller runs in your repo's
  own GitHub Actions (or from the CLI). Nothing loopdog-hosted.
...
- [Architecture & vision](docs/architecture.md) — what loopdog is and why.
- [Codebase layout](docs/codebase.md) — the `@loopdog/*` package boundaries.
...
npm run build      # typecheck + build all @loopdog/* packages
