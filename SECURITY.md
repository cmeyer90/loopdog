...
Loopdog orchestrates provider cloud agents against your repository. The
...
- Loopdog's controller authenticates as the GitHub Actions `GITHUB_TOKEN` of
...
- Never commit `/fire` URLs or bearer tokens; import them as GitHub Actions
  secrets. Loopdog refuses to serialize secret material into model-visible
