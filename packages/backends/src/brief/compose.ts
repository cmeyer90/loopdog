...
export const BUILTIN_POLICIES: Record<string, string> = {
  'output-contract': [
    ...
    '- If your result is a comment (review / grooming / clarification), that',
    '  summary comment MUST also end with the exact trailer line',
    '  `loopdog-run: {{run_id}}` so loopdog can correlate it to this run.',
